/*站点实例区域集合表*/
delete from PS_TZ_SITEI_AREA_T where TZ_SITEI_ID=(
	select TZ_SITEI_ID from PS_TZ_SITEI_DEFN_T where TZ_JG_ID='DYTMBA'
);

/*站点实例区域类型定义表*/
delete from PS_TZ_SITEI_ATYP_T where TZ_SITEI_ID=(
	select TZ_SITEI_ID from PS_TZ_SITEI_DEFN_T where TZ_JG_ID='DYTMBA'
);

/*站点实例菜单表*/
delete from PS_TZ_SITEI_MENU_T where TZ_SITEI_ID=(
	select TZ_SITEI_ID from PS_TZ_SITEI_DEFN_T where TZ_JG_ID='DYTMBA'
);

/*站点实例菜单功能类型图标*/
delete from PS_TZ_SITEI_CDPF_T where TZ_SITEI_ID=(
	select TZ_SITEI_ID from PS_TZ_SITEI_DEFN_T where TZ_JG_ID='DYTMBA'
);

/*站点实例菜单功能类型定义表*/
delete from PS_TZ_SITEI_MTYP_T where TZ_SITEI_ID=(
	select TZ_SITEI_ID from PS_TZ_SITEI_DEFN_T where TZ_JG_ID='DYTMBA'
);

/*站点实例栏目定义表*/
delete from PS_TZ_SITEI_COLU_T where TZ_SITEI_ID=(
	select TZ_SITEI_ID from PS_TZ_SITEI_DEFN_T where TZ_JG_ID='DYTMBA'
);

/*站点实例模板集合表*/
delete from PS_TZ_SITEI_TEMP_T where TZ_SITEI_ID=(
	select TZ_SITEI_ID from PS_TZ_SITEI_DEFN_T where TZ_JG_ID='DYTMBA'
);

/*站点实例菜单图标*/
delete from PS_TZ_SITEI_MNPF_T where TZ_SITEI_ID=(
	select TZ_SITEI_ID from PS_TZ_SITEI_DEFN_T where TZ_JG_ID='DYTMBA'
);
...
delete from PS_TZ_ART_TITIMG_T where TZ_ATTACHSYSFILENA in (
	select TZ_ATTACHSYSFILENA from PS_TZ_ART_REC_TBL where TZ_ART_ID in (
		select TZ_ART_ID from PS_TZ_LM_NR_GL_T where TZ_SITE_ID=(
			select TZ_SITEI_ID from PS_TZ_SITEI_DEFN_T where TZ_JG_ID='DYTMBA'
		)
	)
);
...
/*站点栏目内容关联表*/
delete from PS_TZ_LM_NR_GL_T where TZ_SITE_ID=(
	select TZ_SITEI_ID from PS_TZ_SITEI_DEFN_T where TZ_JG_ID='DYTMBA'
);

/*站点实例表*/
delete from PS_TZ_SITEI_DEFN_T where TZ_JG_ID='DYTMBA';