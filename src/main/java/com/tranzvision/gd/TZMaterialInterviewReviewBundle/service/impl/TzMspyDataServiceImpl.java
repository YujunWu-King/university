 ...
 *
 */
@Service("com.tranzvision.gd.TZMaterialInterviewReviewBundle.service.impl.TzMspyDataServiceImpl")
public class TzMspyDataServiceImpl extends FrameworkImpl {

	@Autowired
	private MsXmlToWord msXmlToWord;
	...
	public String tzOther(String oprType, String comParams, String[] errorMsg) {
		...
		if (StringUtils.isBlank(TZ_CLASS_ID) || StringUtils.isBlank(TZ_APPLY_PC_ID)
			...
			try {
				url = msXmlToWord.createWord(TZ_CLASS_ID, TZ_APPLY_PC_ID, TZ_PWEI_OPRIDS);
