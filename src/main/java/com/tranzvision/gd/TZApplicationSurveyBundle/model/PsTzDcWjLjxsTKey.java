...
public class PsTzDcWjLjxsTKey {
    private String tzDcLjtjId;

    private String tzDcWjId;

    private String tzXxxBh;

    public String getTzDcLjtjId() {
        return tzDcLjtjId;
    }

    public void setTzDcLjtjId(String tzDcLjtjId) {
        this.tzDcLjtjId = tzDcLjtjId == null ? null : tzDcLjtjId.trim();
    }
