 ...
 *
 */
@Service("com.tranzvision.gd.TZApplicationSurveyBundle.service.impl.SurveyViewImageImpl")
public class SurveyViewImageImpl extends FrameworkImpl {
	...
	public String tzGetJsonData(String strParams) {
		...
		String sql = "SELECT B.TZ_APP_TPL_LAN FROM PS_TZ_DC_INS_T A,PS_TZ_DC_WJ_DY_T B WHERE A.TZ_APP_INS_ID = ? AND A.TZ_DC_WJ_ID = B.TZ_DC_WJ_ID";
		...
		try {
			retHtml = tzGdObject.getHTMLText("HTML.TZFileUploadBundle.TZ_PDF_READER_HTML", sysfileName, readerTitle,
					String.valueOf(height), contextUrl);
