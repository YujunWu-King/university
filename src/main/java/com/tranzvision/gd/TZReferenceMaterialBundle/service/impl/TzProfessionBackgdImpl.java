 ...
 * 2017-04-01
 */
@Service("com.tranzvision.gd.TZReferenceMaterialBundle.service.impl.TzProfessionBackgdImpl")
public class TzProfessionBackgdImpl implements TzRefMaterialBase {
	...
	public String genRefDataPage(Map<String, String> dataMap) {
		...
		try{
			...
			String appTmpId = "";
			try{
				appTmpId = getHardCodePoint.getHardCodePointVal("TZ_CKZL_ZYBJ_ZMB");
			}catch(Exception e1){
				e1.printStackTrace();
				errorMsg = "报名表附属模板未定义";
			}
