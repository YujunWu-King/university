...
public class TzZddfXLFServiceImpl extends TzZddfServiceImpl {
	...
	public float AutoCalculate(String TZ_APP_ID, String TZ_SCORE_ID, String TZ_SCORE_ITEM) {
		try {
			...
			String TZ_XXX_BH = "'zgjyTZ__1sch','zgjyTZ_zgjy_4','zgjyTZ_zgjy_3','zgjyTZ_zgjy_11'";
			...
			// 获取分数
			String SearchSql = "select TZ_CSMB_SCOR from PS_TZ_CSMB_XLF_T where TZ_CSMB_CK3=? and  TZ_CSMB_CK2=? and TZ_CSMB_CK2=?";
