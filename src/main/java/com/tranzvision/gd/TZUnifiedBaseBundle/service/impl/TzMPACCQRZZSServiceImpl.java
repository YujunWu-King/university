...
/**
 * MPACC全日制专业资格证书、职称证书计算
 * @author Administrator
 *
 */
@Service("com.tranzvision.gd.TZUnifiedBaseBundle.service.impl.TzMPACCQRZZSServiceImpl")
public class TzMPACCQRZZSServiceImpl extends TzZddfServiceImpl{
	@Autowired
