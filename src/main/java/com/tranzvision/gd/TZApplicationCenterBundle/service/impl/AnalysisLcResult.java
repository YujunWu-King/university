...
public class AnalysisLcResult {
	 ...
	 * 
	 * @param type
	 *            "A":表示报名中心传入解析，"B"表示面试申请页面，"C"表示历史报名页面
	 * @param TZ_APP_INS_ID
	 *            报名表id
	 * @param rootPath
	 *            项目根目录
	 ...
	 * @return
	 */
	public String[] analysisLcNOZWF(String type, String TZ_APP_INS_ID, String rootPath, String sysvarId,
			String isMobile, String siteId) {
		String[] result = { "", "" };
		String isFb = "";
