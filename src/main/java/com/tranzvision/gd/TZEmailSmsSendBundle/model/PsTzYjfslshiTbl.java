...
public class PsTzYjfslshiTbl {
    private String tzRwslId;

    private String tzFsEmail;

    private String tzJsEmail;

    private String tzEmZhuti;
    ...
    public String getTzFsEmail() {
        return tzFsEmail;
    }

    public void setTzFsEmail(String tzFsEmail) {
        this.tzFsEmail = tzFsEmail == null ? null : tzFsEmail.trim();
    }

    public String getTzJsEmail() {
        return tzJsEmail;
    }

    public void setTzJsEmail(String tzJsEmail) {
        this.tzJsEmail = tzJsEmail == null ? null : tzJsEmail.trim();
    }

    public String getTzEmZhuti() {
        return tzEmZhuti;
    }

    public void setTzEmZhuti(String tzEmZhuti) {
        this.tzEmZhuti = tzEmZhuti == null ? null : tzEmZhuti.trim();
    }
