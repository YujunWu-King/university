 ...
 *
 */
@Service("com.tranzvision.gd.TZRecruitStuViewBundle.service.impl.TZCandidateNoticeServicerImpl")
public class TZCandidateNoticeServicerImpl extends FrameworkImpl {
	@Autowired
