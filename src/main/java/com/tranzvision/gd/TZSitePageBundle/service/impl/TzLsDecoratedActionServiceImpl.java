...
/**
 * 原PS：TZ_SITE_DECORATED_APP:TZ_LS_DECORATED_CLS
 * 
 * @author SHIHUA
 * @since 2016-01-14
 */
@Service("com.tranzvision.gd.TZSitePageBundle.service.impl.TzLsDecoratedActionServiceImpl")
public class TzLsDecoratedActionServiceImpl extends TzSiteActionServiceImpl {
