 ...
 * @since 2015-12-16
 */
@Service("com.tranzvision.gd.TZSitePageBundle.service.impl.TzGwDecoratedServiceImpl")
public class TzGwDecoratedServiceImpl extends FrameworkImpl {
	...
	public String tzQuery(String strParams, String[] errMsg) {
		...
		try {
			...
			strRet = tzGDObject.getHTMLText("HTML.TZSitePageBundle.TzGwForm", strSiteId, strAreaId, strAreaZone,
