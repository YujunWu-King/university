 ...
 * @since 2015-12-17
 */
@Service("com.tranzvision.gd.TZSitePageBundle.service.impl.TzPtDecoratedServiceImpl")
public class TzPtDecoratedServiceImpl extends FrameworkImpl {
	...
	public String tzQuery(String strParams, String[] errMsg) {
		...
		try {
			...
			strRet = tzGDObject.getHTMLText("HTML.TZSitePageBundle.TzYwForm", strSiteId, strAreaId, strAreaZone,
