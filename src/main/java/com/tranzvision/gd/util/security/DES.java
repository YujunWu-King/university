...
public class DES {
	 ...
	 */
	public static String strEncode(String data, String firstKey,
	 ...
	 */
	public static String strDecode(String data, String firstKey,
			String secondKey, String thirdKey) {
		int leng = data.length();
		String decStr = "";
		List firstKeyBt = null, secondKeyBt = null, thirdKeyBt = null;
	...
	public static int[] enc(int[] dataByte, int[] keyByte) {
		...
		for (i = 0; i < 16; i++) {
			...
			int[] tempRight = xor(pPermute(sBoxPermute(xor(expandPermute(ipRight),
					key))),
					tempLeft);
			for (n = 0; n < 32; n++) {
