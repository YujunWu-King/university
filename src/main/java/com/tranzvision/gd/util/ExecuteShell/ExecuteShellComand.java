...
public class ExecuteShellComand {
	 ...
	 * 
	 * @param parentPath 	header.html、footer.html文件路径
	 * @param sourcePath 	源文件路径(报名表实例对应的HTML)
	 * @param sourceName 	报名表实例对应的HTML文件名称
	 * @param targetName 	要生产的PDF文件名称
	 * @param pdfPath 		PDF的绝对路
	 * @return
	 */
	public String executeCommand(String parentPath, String sourcePath, String sourceName, String targetName, String pdfPath) {
