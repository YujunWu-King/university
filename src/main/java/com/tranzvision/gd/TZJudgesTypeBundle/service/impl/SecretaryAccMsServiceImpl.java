 ...
 * 功能说明：面试秘书账号管理列表页面;
 */
@Service("com.tranzvision.gd.TZJudgesTypeBundle.service.impl.SecretaryAccMsServiceImpl")
public class SecretaryAccMsServiceImpl extends FrameworkImpl {
	@Autowired
	...
	public String tzQueryList(String comParams, int numLimit, int numStart, String[] errorMsg) {
		...
		// json数据要的结果字段;
		String[] resultFldArray = { "TZ_JG_ID", "TZ_DLZH_ID", "TZ_REALNAME","TZ_MOBILE", "TZ_EMAIL" };
