...
@Service("com.tranzvision.gd.TZWebSelectorBundle.service.impl.SemClassClsServiceImpl")
public class SemClassClsServiceImpl extends FrameworkImpl {
				...
				if (psTzClassInfT != null) {
					...
					if (classList != null && classList.size() > 0) {
						for (int i = 0; i < classList.size(); i++) {
							...
							try {
								classInfo = classInfo
										+ tzGdObject.getHTMLText("HTML.TZWebSelectorBundle.TZ_MCLASS_A_HTML", "CLASS_RD",
					...
					try {
						return tzGdObject.getHTMLText("HTML.TZWebSelectorBundle.TZ_MCLASS_SELECT_HTML",false, classInfo,
