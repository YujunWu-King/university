 ...
 * 面试异常数据管理-班级批次列表
 */
@Service("com.tranzvision.gd.TZApplicationVerifiedBundle.service.impl.TzGdMsErrorDataServiceImpl")
public class TzGdMsErrorDataServiceImpl extends FrameworkImpl {
	@Autowired
	...
	public String tzQueryList(String comParams, int numLimit, int numStart, String[] errorMsg) {
		...
		try {
			...
			// json数据要的结果字段;
			String[] resultFldArray = { "TZ_CLASS_ID", "TZ_CLASS_NAME", "TZ_BATCH_ID", "TZ_BATCH_NAME"};
