 ...
 */
@Service("com.tranzvision.gd.TZWebSiteRegisteBundle.service.impl.SemUploadPhotoServiceImpl")
public class SemUploadPhotoServiceImpl extends FrameworkImpl {
	@Autowired
	...
	public String tzGetHtmlContent(String strParams) {
		...
		try {
			...
			String TZ_ENROLL_UPLOADPHO = tzGdObject.getHTMLText("HTML.TZWebSiteRegisteBundle.TZ_GD_PHO_HTML2", phoToData,
