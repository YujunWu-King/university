...
public class TzGetProjectTemplate {

	private SqlQuery sqlQuery;
	public TzGetProjectTemplate() {
	...
	public List<String> getOwnerId(String wflInsId, String stpInsId, String wflRecId) {
		...
		//String name = sqlQuery.queryForObject("SELECT tzms_apply_user FROM tzms_teacher_lesson_contract WHERE tzms_teacher_lesson_contractid = '"+wflRecId+"'", "String");
