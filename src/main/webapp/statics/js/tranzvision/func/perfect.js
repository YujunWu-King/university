...
$(document).ready(function(){
	...
	$.each([$("#TZ_COUNTRY"),$("#TZ_COUNTRY_click")],function(i,el){
		el.click(function(e) { 
			...
			s = $.layer({
				...
				offset: ['50%',''],
				area: ['830px','610px'],
				iframe: {src: TzUniversityContextPath + '/dispatcher?tzParams={"ComID":"TZ_COMMON_COM","PageID":"TZ_COUNTRY_STD","OperateType":"HTML","comParams":{"siteId":"'+$("#siteid").val()+'"}}'}
			});
		});
	});
	...
	$("#TZ_SCH_CNAME_Country").click(function(e){
		...
		s = $.layer({
			...
			offset: ['30%',''],
			area: ['830px','610px'],
			iframe: {src: TzUniversityContextPath + '/dispatcher?tzParams='+encodeURIComponent('{"ComID":"TZ_COMMON_COM","PageID":"TZ_COUNTRY_STD","OperateType":"HTML","comParams":{"siteId":"'+$("#siteid").val()+'"}}')}
		});
	});
	$("#TZ_SCH_CNAME_click").click(function(e) {
		...
		s = $.layer({
			...
			iframe: {src: TzUniversityContextPath + '/dispatcher?tzParams='+encodeURIComponent('{"ComID":"TZ_COMMON_COM","PageID":"TZ_SCHOOL_STD","OperateType":"HTML","comParams":{"siteId":"'+$("#siteid").val()+'","Type":"A"}}')}
		});
    });
	//默认国家为中国
	...
	$.each([$("#TZ_LEN_PROID"),$("#TZ_LEN_PROID_click")],function(i,el){
		el.click(function(e) { 
			...
			prov = $.layer({
				...
				offset: ['100px',''],
				area: ['588px','300px'],
				iframe: {src: TzUniversityContextPath + '/dispatcher?tzParams='+encodeURIComponent('{"ComID":"TZ_COMMON_COM","PageID":"TZ_PROVINCE_STD","OperateType":"HTML","comParams":{"TZ_PROV_ID":"'+_prov_id+'","siteId":"'+$("#siteid").val()+'"}}')},
			});
		});
    });
