    ...
    _getHtml: function(data, previewmode) {
        ...
        if (previewmode) {
            if(SurveyBuild._readonly){
                ...
                c += '  </div>';
                c += '  <div class="main_inner_content_info_readonly_right" >' + valDesc + '</div>';
                c += '</div>'
            }else{
                ...
                c += '          <select name="' + data.itemId + '" class="chosen-select" id="' + data.itemId + '" style="width:254px;" title="' + data.itemName + '">';
                c +=                    e;
                c += '          </select>';
                c += '      </div>';
