        ...
        if (previewmode) {
			...
			for (var i in data.child) {
				...
				for (var j in data.option) {
					s += '<td><img src="' + TzUniversityContextPath + '/statics/images/appeditor/read-check.gif"></td>';	
				}
				s += '</tr>';	
			}
