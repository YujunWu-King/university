...
//    		var $inputBox = $("#TZ_SCH_CNAME_Country");
			...
			$.each([$inputBox],function(i, el) {
				el.click(function(e) { 
					...
					var tzParams = '{"ComID":"TZ_COMMON_COM","PageID":"TZ_M_COUNTRY_STD2","OperateType":"HTML","comParams":{"orgid":"MBA","siteId":"'+siteId+'","lang":"'+ SurveyBuild.BMB_LANG +'","sen":"2"}}';
...
//			var $schoolBox = $("#sch_" + data.itemId);
			...
			$.each([$schoolBox],function(i, el) {
				...
				var tzParams = '{"ComID":"TZ_COMMON_COM","PageID":"TZ_M_SCHOOL_STD2","OperateType":"HTML","comParams":{"orgid":"MBA","siteId":"'+siteId+'","lang":"'+ SurveyBuild.BMB_LANG +'","Type":"B"}}';
				$.ajax({
					type: "post",
					async :false,
					data:{
