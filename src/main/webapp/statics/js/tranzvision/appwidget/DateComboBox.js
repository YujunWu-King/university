	...
	_getHtml: function(data, previewmode) {
		...
		if (previewmode) {
			if(SurveyBuild._readonly){
				...
				c += '		<img id="' + data["itemId"] + children[0]["itemId"] + '_Btn" src="../../images/appeditor/calendar.png" style="position:relative;left:'+(data.todatebz == "Y" && children[2]["value"] == "Y" ? "-39px" : "-171px")+';cursor:pointer;">';
				c += '		<img id="' + data["itemId"] + children[1]["itemId"] + '_Btn" src="../../images/appeditor/calendar.png" style="position:relative;left:-69px;cursor:pointer;'+(data.todatebz == "Y" && children[2]["value"] == "Y" ? "display:none;": "")+'">';
				if(data.hasOwnProperty("todatebz") && data.todatebz == "Y"){
