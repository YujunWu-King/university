	...
	_getHtml: function(data, previewmode) {
		...
		if (previewmode) {
			if(SurveyBuild._readonly){
				...
				c += '		<img id="' + data["itemId"] + children[0]["itemId"] + '_Btn" src="/tranzvision/images/calendar.png" style="position:relative;left:'+(data.todatebz == "Y" && children[2]["value"] == "Y" ? "-39px" : "-171px")+';cursor:pointer;">';
