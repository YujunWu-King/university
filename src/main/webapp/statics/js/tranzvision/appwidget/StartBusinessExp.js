						...
						NET_DIV+='<div class="right" name="financingGp" style="width:65%;height:240px">'
							...
							NET_DIV+='<div id="FB">'
								NET_DIV+='<div name="financingB" class="input-list-text left" style="width:53%">'
									NET_DIV+='<div class="left" style="width:30%"><div class="radio-btn'+(FINANCING_DEL=="B_FINANCING"?' checkedRadio': '')+'"><i><input type="radio" name="financing_type" value="B_FINANCING" '+(FINANCING_DEL=="B_FINANCING"?'checked="checked"': '')+'></i></div>'+MsgSet["B_FINANCING"]+'</div>'
									NET_DIV+='<div class="right" style="width:70%;  '+(FINANCING_DEL=="B_FINANCING"?'':' display:none')+'"><input class="inpu-list-text-enter" style="width:100%;margin-left:2.5px;margin-top:2.5px;height:35px"  id="'+data["itemId"] + child.WorkExper2_1.itemId+'" value="'+child.WorkExper2_1.value+'"></div>'
								NET_DIV+='</div>'
							...
							NET_DIV+='<div id="FA">'
								NET_DIV+='<div name="financingA" class="input-list-text left" style="width:53%">'
									NET_DIV+='<div class="left" style="width:30%"><div class="radio-btn'+(FINANCING_DEL=="A_FINANCING"?' checkedRadio': '')+'"><i><input type="radio" name="financing_type" value="A_FINANCING" '+(FINANCING_DEL=="A_FINANCING"?'checked="checked"': '')+'></i></div>'+MsgSet["A_FINANCING"]+'</div>'
									NET_DIV+='<div class="right" style="width:70%; '+(FINANCING_DEL=="A_FINANCING"?'':' display:none')+'"><input class="inpu-list-text-enter" style="width:100%;margin-left:2.5px;margin-top:2.5px;height:35px"  id="'+data["itemId"] + child.WorkExper2_2.itemId+'" value="'+child.WorkExper2_2.value+'"></div>'
								NET_DIV+='</div>'
							...
							NET_DIV+='<div id="FAN">'
								NET_DIV+='<div name="financingAn" class="input-list-text left" style="width:53%">'
									NET_DIV+='<div class="left" style="width:30%"><div class="radio-btn'+(FINANCING_DEL=="ANGEL_INVEST"?' checkedRadio': '')+'"><i><input type="radio" name="financing_type" value="ANGEL_INVEST" '+(FINANCING_DEL=="ANGEL_INVEST"?'checked="checked"': '')+'></i></div>'+MsgSet["ANGEL_INVEST"]+'</div>'
									NET_DIV+='<div class="right" style="width:70%; '+(FINANCING_DEL=="ANGEL_INVEST"?'':' display:none')+'"><input class="inpu-list-text-enter" style="width:100%;margin-left:2.5px;margin-top:2.5px;height:35px"  id="'+data["itemId"] + child.WorkExper2_3.itemId+'" value="'+child.WorkExper2_3.value+'"></div>'
								NET_DIV+='</div>'
