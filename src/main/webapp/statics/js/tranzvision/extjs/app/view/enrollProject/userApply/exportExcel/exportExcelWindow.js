Ext.define('KitchenSink.view.enrollProject.userApply.exportExcel.exportExcelWindow', {
    extend: 'Ext.window.Window',
    xtype: 'userApplyExportExcelWindow',
    controller: 'userApplyExportExcel',
    requires: [
        'Ext.data.*',
        'Ext.grid.*',
        'Ext.util.*',
        ...
        'KitchenSink.view.enrollProject.userApply.exportExcel.exportExcelStore',
        'KitchenSink.view.enrollProject.userApply.exportExcel.exportExcelController'
    ],
    modal:true,//背景遮罩
    header:false,
    resizable:false,
    ...
    initComponent: function(){
		...
		var listStore = new KitchenSink.view.enrollProject.userApply.exportExcel.exportExcelStore;
