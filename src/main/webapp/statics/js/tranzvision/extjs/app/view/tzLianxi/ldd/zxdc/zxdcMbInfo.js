Ext.define('KitchenSink.view.tzLianxi.ldd.zxdc.zxdcMbInfo', {
    ...
    requires: [
        ...
        'KitchenSink.view.tzLianxi.ldd.zxdc.zxdcMbModel',
        'KitchenSink.view.tzLianxi.ldd.zxdc.zxdcMbController',
    ...
    initComponent: function () {
        var store = new KitchenSink.view.tzLianxi.ldd.zxdc.zxdcMbListStore();
        Ext.apply(this, {
            columns: [
                    ...
                    },
                {
                    ...
                    items:[
                        ...
                        {iconCls:'import',tooltip:'逻辑',handler:'luojiWjmb'}
