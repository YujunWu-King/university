Ext.define("KitchenSink.view.tzLianxi.liuzh.bugMg.oprController",{
    requires:[
        'KitchenSink.view.tzLianxi.liuzh.bugMg.oprStore'
    ],
        ...
        Ext.tzShowPromptSearch({
            ...
            callback: function(selection){
                ...
                for(var i=0;i<selection.length;i++){
                    ...
                    var model = new KitchenSink.view.tzLianxi.liuzh.bugMg.oprStruct({
                        oprID:oprID,
                        name:name,
                        role:'0'
                    });
