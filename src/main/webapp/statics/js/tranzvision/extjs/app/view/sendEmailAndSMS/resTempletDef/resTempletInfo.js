			...
			{	
				...
				items:[{
					...
					items:[{
						...
						xtype: 'checkbox',
						boxLabel: Ext.tzGetResourse("TZ_RES_TMPL_MG_COM.TZ_RES_TMPL_STD.isDefaultOpen","默认开通模版"),
						name:'isDefaultOpen',
						checked:true,
						inputValue:'Y',
						uncheckedValue:'N'
						...
						xtype: 'checkbox',
						boxLabel: Ext.tzGetResourse("TZ_RES_TMPL_MG_COM.TZ_RES_TMPL_STD.isExtendChildTmpl","机构可扩展子模版"),
						...
						xtype: 'checkbox',
						boxLabel: Ext.tzGetResourse("TZ_RES_TMPL_MG_COM.TZ_RES_TMPL_STD.ispersonalize","是否包含动态个性化内容"),
						name:'ispersonalize',
						inputValue: 'Y',
						uncheckedValue:'N'
					},{
