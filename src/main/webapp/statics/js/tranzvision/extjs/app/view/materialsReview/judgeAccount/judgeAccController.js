Ext.define('KitchenSink.view.materialsReview.judgeAccount.judgeAccController', {
	...
	judgeAccInfoHandler: function(accNum, oprid, type){
		...
		var params = '{"ComID":"TZ_JUDGE_ACC_COM","PageID":"TZ_JUDINFO_STD","OperateType":"QG","comParams":{}}';
		Ext.tzLoad(params, function(resp){
			...
			if (type == "add"){
				...
				//参数
				var tzParams = '{"ComID":"TZ_JUDGE_ACC_COM","PageID":"TZ_JUDACC_GL_STD","OperateType":"QF","comParams":{"oprId":"'+oprid+'"}}';
