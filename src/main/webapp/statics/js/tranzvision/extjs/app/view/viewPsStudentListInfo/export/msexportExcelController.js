Ext.define('KitchenSink.view.viewPsStudentListInfo.export.msexportExcelController', {
		   ...
		   condition:
            {
                ...
                "TZ_COM_ID": "TZ_REVIEW_MS_COM",
                "TZ_PAGE_ID": "TZ_MSPS_KS_STD"
            },   
	...
	downloadFile: function(grid, rowIndex){
        ...
        if(procInsId != ""){
        	 var tzParams = '{"ComID":"TZ_REVIEW_MS_COM","PageID":"TZ_MSPS_KS_STD","OperateType":"DOWNLOAD","comParams":{"procInsId":"'+ procInsId +'"}}';
             //保存数据
