Ext.define('KitchenSink.view.automaticScreen.autoScreen.setWeedOutWindow', {
	...
	constructor: function(config, callback){
		...
		var respJson;
		var tzParams ='{"ComID":"TZ_AUTO_BASE_COM","PageID":"TZ_AUTO_SCREEN_BS","OperateType":"queryWeedOutInfo","comParams":{"classId":"'+ config.classId +'","batchId":"'+ config.batchId +'"}}';
