Ext.define('KitchenSink.view.viewPsStudentListInfo.export.msexportExcelStore', {
    extend: 'Ext.data.Store',
    alias: 'store.exportExcelStore',
    model: 'KitchenSink.view.viewPsStudentListInfo.export.msexportExcelModel',
    autoLoad: true,
    pageSize: 5,
    ...
    constructor: function(classBatch){
    	this.tzStoreParams = '{"type":"expHistory","cfgSrhId":"TZ_REVIEW_CL_COM.TZ_CLPS_KS_STD.TZ_EXCEL_DC_V","condition":{"TZ_DLZH_ID-operator": "01","TZ_DLZH_ID-value": "'
    		...
    		+'","TZ_COM_ID-operator": "01","TZ_COM_ID-value": "TZ_REVIEW_MS_COM","TZ_PAGE_ID-operator": "01","TZ_PAGE_ID-value": "TZ_MSPS_KS_STD"}}';
