Ext.define('KitchenSink.view.bzScoreMathCalcuter.export.msexportExcelController', {
	...
	ensureExport: function(btn){
		...
		if(form.isValid()){
			...
			var jsonData = '{"ComID":"TZ_BZCJ_SRC_COM","PageID":"TZ_BZCJ_JIS_STD","OperateType":"EXPORT","comParams":{"add":[' + exportObj + '],"coulumdt":' + win.coulumdt + ',"fileName":"'+formRec.FileName+'"}}'
		   ...
		   condition:
            {
                ...
                "TZ_COM_ID": "TZ_BZCJ_SRC_COM",
                "TZ_PAGE_ID": "TZ_BZCJ_JIS_STD"
            },   
