Ext.define('KitchenSink.view.automaticScreen.autoScreenStore', {
	...
	constructor: function(config){
		...
		this.tzStoreParams = '{'+itemsParams+','+itemsMsParams+',"cfgSrhId":"TZ_AUTO_SCREEN_COM.TZ_AUTO_SCREEN_STD.TZ_CS_STU_VW","condition":{"TZ_CLASS_ID-operator": "01","TZ_CLASS_ID-value": "'+ classId+'","TZ_BATCH_ID-operator": "01","TZ_BATCH_ID-value": "'+ batchId+'"}}';
