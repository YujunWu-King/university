...
Ext.define('KitchenSink.view.security.menu.menuEditPanel', {
    ...
    viewModel: true,
    actType: 'update',
    dataLanguage: TranzvisionMeikecityAdvanced.Boot.getLanguage(),
        ...
        this.items = [
            {
              ...
              // height: 400,
                ...
                lines: true,
								...
								store: new KitchenSink.view.security.menu.menuTreeStore({menuId: me.menuId,dataLanguage: me.dataLanguage}),
								/*
								viewConfig: {
								    plugins: { 
               ...
               // glyph: 117,
                ...
                items: [{
                    xtype:"toolbar",
                    items:[
                        {text:"插入同级节点",iconCls:'siblingnode',tooltip:"插入同级节点",handler: 'inserMenueItem'},"-",
                        {text:"插入子节点",iconCls:'childnode',tooltip:"插入子节点",handler: 'inserChildMenueItem'},"-",
                        {text:"删除",iconCls:'remove',tooltip:"删除",handler: 'removeMenueItem'},"->",
                        {xtype:'splitbutton',
                         text:'更多操作',
                         iconCls:'list',
                         glyph: 61,
