Ext.define('KitchenSink.view.tzLianxi.ZXE.ZXDCKJSZ.dckjJygzController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.dckjJygzController',

    pmtSearchJygz: function(btn){
        var form = this.getView().child("form").getForm();
        Ext.tzShowPromptSearch({
            recname: 'TZ_DC_JYGZ_DY_T',
            searchDesc: '校验规则',
            maxRow:20,
            condition:{
                presetFields:{
    ...
    sureKjJygz: function(btn){
        ...
        //Params
        var tzParams = '{"ComID":"TZ_ZXDC_KJGL_COM","PageID":"TZ_DCKJJYGZ_STD","OperateType":"U","comParams":{"update":['+Ext.JSON.encode(formParams)+']}}';
