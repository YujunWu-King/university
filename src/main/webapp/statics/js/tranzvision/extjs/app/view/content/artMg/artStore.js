Ext.define('KitchenSink.view.content.artMg.artStore', {
	...
	constructor: function (siteId,columnId) {
        //this.tzStoreParams = '{"columnId":"' + columnId + '"}';
        this.tzStoreParams = '{"cfgSrhId":"TZ_ART_MG_COM.TZ_ART_LIST_STD.TZ_GD_CONTENT_V","condition":{"TZ_SITE_ID-operator":"01","TZ_SITE_ID-value":"'+siteId+'","TZ_COLU_ID-operator":"01","TZ_COLU_ID-value":"'+columnId+'"}}';
        this.callParent();
    },
