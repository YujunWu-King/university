Ext.define('KitchenSink.view.enrollProject.userApply.userApplyDynAud', {
    ...
    requires: [
			...
			//   'KitchenSink.view.audienceManagement.myEnrollmentClueController',
               'KitchenSink.view.enrollProject.userApply.userApplyAudStore'
           ],
	...
	initComponent: function () {
		var store = new KitchenSink.view.enrollProject.userApply.userApplyAudStore();
