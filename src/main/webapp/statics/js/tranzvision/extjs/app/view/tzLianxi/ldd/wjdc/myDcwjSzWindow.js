Ext.define('KitchenSink.view.tzLianxi.ldd.wjdc.myDcwjSzWindow', {
       ...
       items:[
           {
               ...
               items: [
                   ...
                   {
                       xtype: 'textfield',
                       fieldLabel: Ext.tzGetResourse("TZ_ZXDC_WJGL_COM.TZ_ZXDC_WJGL_STD.TZ_DC_WJ_PC_URL", "PC版发布URL"),
                       name: 'TZ_DC_WJ_PC_URL'
                   },
                   {
                       xtype: 'textfield',
                       fieldLabel: Ext.tzGetResourse("TZ_ZXDC_WJGL_COM.TZ_ZXDC_WJGL_STD.TZ_DC_WJ_MB_URL", "移动版发布URL"),
                       name: 'TZ_DC_WJ_MB_URL'
                   },
                   {
                       xtype: 'checkboxfield',
                       fieldLabel: Ext.tzGetResourse("TZ_ZXDC_WJGL_COM.TZ_ZXDC_WJGL_STD.TZ_DC_WJ_DLZT", "非登录用户也可以参与本次调查，如果勾选则一下听众列表不在生效"),
                       name: 'TZ_DC_WJ_DLZT',
                       boxLabel:'非登录用户也可以参与本次调查，如果勾选则一下听众列表不在生效',
                       hideLabel:true,
                       ...
                       items: [
                           {
                               ...
                               name      : 'TZ_DC_WJ_DTGZ',
                               inputValue: '0',
                               itemId:'TZ_DC_WJ_DTGZ_0'

                           }, {
                               boxLabel  : '不能修改过往问题答案',
                               name      : 'TZ_DC_WJ_DTGZ',
                               inputValue: '1',
                               itemId:'TZ_DC_WJ_DTGZ_1'
                           }, {
                               boxLabel  : '只要还在调查期间内，就可以修改已提交调查问卷的答案',
                               name      : 'TZ_DC_WJ_DTGZ',
                               inputValue: '2',
                               itemId:'TZ_DC_WJ_DTGZ_2'
                           }
                       ]
                   },{
                       xtype  : 'fieldcontainer',
