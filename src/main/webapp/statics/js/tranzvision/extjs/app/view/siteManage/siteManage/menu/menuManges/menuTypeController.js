Ext.define('KitchenSink.view.siteManage.siteManage.menu.menuManges.menuTypeController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.siteTypeInfo1', 
	requires: [
       'KitchenSink.view.siteManage.siteManage.menu.menuManges.menuTypeIconwindow'
    ],
	editSiteSkin: function(view, rowIndex){
		...
		//是否有访问权限
		var pageResSet = TranzvisionMeikecityAdvanced.Boot.comRegResourseSet["TZ_GD_ZDGL_COM"]["TZ_GD_ICON1_STD"];
		...
		if(className == "" || className == undefined){
			Ext.MessageBox.alert('提示', '未找到该功能页面对应的JS类，页面ID为：TZ_GD_ICON1_STD，请检查配置。');
			return;
		}
		
		var win = this.lookupReference('menuTypeIconwindow');
		...
		//参数
		var tzParams = '{"ComID":"TZ_GD_ZDGL_COM","PageID":"TZ_GD_ICON1_STD","OperateType":"QF","comParams":{"siteId":"'+siteId+'","menutypeid":"'+menutypeid+'","skinId":"'+skin_id+'"}}';
		//加载数据
	...
	onFormSave: function(btn){
		...
		*/
		...
		//提交参数
		var tzParams = '{"ComID":"TZ_GD_ZDGL_COM","PageID":"TZ_ZD_CDLXSZ_STD","OperateType":"U","comParams":{'+comParams+'}}';
