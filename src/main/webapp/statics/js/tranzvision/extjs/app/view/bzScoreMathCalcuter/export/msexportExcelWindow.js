Ext.define('KitchenSink.view.bzScoreMathCalcuter.export.msexportExcelWindow', {
	...
	requires: [
        ...
        'KitchenSink.view.bzScoreMathCalcuter.export.msexportExcelStore',
        'KitchenSink.view.bzScoreMathCalcuter.export.msexportExcelController'
	],
    modal:true,//背景遮罩
    header:false,
    minHeight: 200,
    ...
    initComponent: function(){
		...
		var listStore = new KitchenSink.view.bzScoreMathCalcuter.export.msexportExcelStore(classBatch);
