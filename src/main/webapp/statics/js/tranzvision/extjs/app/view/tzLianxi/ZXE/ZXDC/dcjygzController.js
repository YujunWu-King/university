Ext.define('KitchenSink.view.tzLianxi.ZXE.ZXDC.dcjygzController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.dcjygz',
    querydcJygz:function(btn){
        Ext.tzShowCFGSearch({
            cfgSrhId: 'TZ_ZXDC_JYGZ_COM.TZ_DCJYGZ_LIST_STD.TZ_DCJYGZ_VW',
    ...
    adddcJygz:function(btn){
        //是否有访问权限
        var pageResSet = TranzvisionMeikecityAdvanced.Boot.comRegResourseSet["TZ_ZXDC_JYGZ_COM"]["TZ_DCJYGZ_INFO_STD"];
        ...
        if(className == "" || className == undefined){
            Ext.MessageBox.alert('提示', '未找到该功能页面对应的JS类，页面ID为：TZ_DCJYGZ_INFO_STD，请检查配置。');
            return;
        }
    ...
    editdcJygz:function(obj,rowIndex){
        var jygzID;
        ...
        cmp.on('afterrender',function(panel){
            ...
            //参数
            var tzParams = '{"ComID":"TZ_ZXDC_JYGZ_COM","PageID":"TZ_DCJYGZ_INFO_STD","OperateType":"QF","comParams":{"jygzID":"'+jygzID+'"}}';
            //加载数据
    ...
    deletedcJygz:function(obj,rowIndex){
        //选中行
    ...
    getJygzInfoParams: function(){
        ...
        //提交参数
        var tzParams = '{"ComID":"TZ_ZXDC_JYGZ_COM","PageID":"TZ_DCJYGZ_INFO_STD","OperateType":"U","comParams":{'+comParams+'}}';
        return tzParams;
    }
});
