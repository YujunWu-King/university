...
//    },
	...
	style:"margin:8px",
    multiSelect: true,
    title:Ext.tzGetResourse("TZ_MS_MGR_COM.TZ_MS_MGR_CLS_STD.panelTitle","面试管理"),
    viewConfig: {
    ...
    initComponent: function () {
        ...
        Ext.apply(this, {
            ...
            /*
            {
                text:Ext.tzGetResourse("TZ_MS_MGR_COM.TZ_MS_MGR_CLS_STD.classID","班级编号") ,
                dataIndex: 'classID',
                hidden:true
            },
             */
            {
                ...
                xtype:'linkcolumn',
                text:Ext.tzGetResourse("TZ_MS_MGR_COM.TZ_MS_MGR_CLS_STD.linkMSGL","面试管理"),
				width:100,
                sortable:false,
                items:[{
                    text:Ext.tzGetResourse("TZ_MS_MGR_COM.TZ_MS_MGR_CLS_STD.linkMSGLItem","面试管理"),
                    handler: "interviewManage",
                    tooltip:Ext.tzGetResourse("TZ_MS_MGR_COM.TZ_MS_MGR_CLS_STD.linkMSGLItemTip","面试管理")
                }]
            }],
            store: store,
            bbar: {
