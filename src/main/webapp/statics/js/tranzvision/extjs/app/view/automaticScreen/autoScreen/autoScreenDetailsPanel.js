Ext.define('KitchenSink.view.automaticScreen.autoScreen.autoScreenDetailsPanel', {
    extend: 'Ext.panel.Panel',
	requires: [
        'Ext.data.*',
        'Ext.util.*',
        'KitchenSink.view.automaticScreen.autoScreen.autoScreenController',
	...
	controller: 'autoScreenControllerBase',
	
	title: Ext.tzGetResourse("TZ_AUTO_BASE_COM.TZ_ZDCS_INFO_STD.autoScreenDetails","自动初筛详细信息"),
...
//                    displayField: 'TZ_LABEL_NAME',
	...
	buttons: [{
		text: Ext.tzGetResourse("TZ_AUTO_BASE_COM.TZ_ZDCS_INFO_STD.save","保存"),
		iconCls:"save",
		handler: 'onAutoScreenDetailsSave'
	}, {
		text: Ext.tzGetResourse("TZ_AUTO_BASE_COM.TZ_ZDCS_INFO_STD.ensure","确定"),
		iconCls:"ensure",
		closePanel:'Y',
		handler: 'onAutoScreenDetailsEnsure'
	}, {
		text: Ext.tzGetResourse("TZ_AUTO_BASE_COM.TZ_ZDCS_INFO_STD.close","关闭"),
		iconCls:"close",
