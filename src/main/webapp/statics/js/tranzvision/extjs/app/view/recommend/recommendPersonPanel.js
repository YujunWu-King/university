Ext.define('KitchenSink.view.recommend.recommendPersonPanel', {
    extend: 'Ext.panel.Panel',
    xtype: 'recommendPerson',
        ...
        Ext.apply(this,{
            items: [{
                ...
                items: [{
                    ...
                    xtype: 'textfield',
                    fieldLabel: Ext.tzGetResourse("TZ_TJR_MANAGER_COM.TZ_TJR_INFO_STD.className","班级"),
                    name: 'className',
                    cls:'lanage_1',
                    readOnly:true
                },{
                    xtype: 'textfield',
                    fieldLabel: Ext.tzGetResourse("TZ_BMGL_BMBSH_COM.TZ_BMGL_STU_STD.batchName","批次"),
                    name: 'batchName',
                    cls:'lanage_1',
                    readOnly:true
                }
