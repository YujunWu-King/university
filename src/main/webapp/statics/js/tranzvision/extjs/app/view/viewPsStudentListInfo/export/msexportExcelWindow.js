Ext.define('KitchenSink.view.viewPsStudentListInfo.export.msexportExcelWindow', {
	...
	requires: [
        ...
        'KitchenSink.view.viewPsStudentListInfo.export.msexportExcelStore',
        'KitchenSink.view.viewPsStudentListInfo.export.msexportExcelController'
	],
    modal:true,//背景遮罩
    header:false,
    minHeight: 200,
    ...
    initComponent: function(){
		...
		var listStore = new KitchenSink.view.viewPsStudentListInfo.export.msexportExcelStore(classBatch);
