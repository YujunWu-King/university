Ext.define('KitchenSink.view.judgesManagement.secretaryAccount.secretaryAccInfoWin', {
    extend: 'Ext.panel.Panel',
    requires: [
          'KitchenSink.view.judgesManagement.secretaryAccount.secretaryAccController'
    ],
    xtype: 'secretaryAccInfo',
	reference: 'secretaryAccInfoWindow',
...
//		var judTpItems = [];
       ...
       /* for(var i=0; i<2; i++){
		...
		Ext.apply(this,{
           ...
           //      bodyStyle:'overflow-y:auto;overflow-x:hidden',
				...
				items: [{
					xtype: 'textfield',
					fieldLabel: Ext.tzGetResourse("TZ_SEC_ACC_COM.TZ_SECINFO_STD.accountNo","用户账号"),
					name: 'accountNo',
					allowBlank: false
				},{
					xtype: 'textfield',
					fieldLabel: Ext.tzGetResourse("TZ_SEC_ACC_COM.TZ_SECINFO_STD.password","密码"),
					inputType: 'password',
					plugins:Ext.KeyBoard,
					name: 'password',
					allowBlank: false
				},{
					xtype: 'textfield',
					fieldLabel: Ext.tzGetResourse("TZ_SEC_ACC_COM.TZ_SECINFO_STD.rePassword","确认密码"),
					inputType: 'password',
					name: 'rePassword',
					allowBlank: false
				},{
					xtype: 'textfield',
					fieldLabel: Ext.tzGetResourse("TZ_SEC_ACC_COM.TZ_SECINFO_STD.judgeName","用户描述"),
					name: 'judgeName'
				},/*{
					layout: {
						type: 'column',
					...
					items:[{
						columnWidth:.35,
						xtype: 'displayfield',
						fieldLabel: Ext.tzGetResourse("TZ_SEC_ACC_COM.TZ_SECINFO_STD.orgId","所属机构"),
						name: 'orgId'
					},{
						columnWidth:.65,
						xtype: 'displayfield',
					...
					xtype: 'checkbox',
					fieldLabel: Ext.tzGetResourse("TZ_SEC_ACC_COM.TZ_SECINFO_STD.clockFlag","锁定用户"),
					name: 'clockFlag',
					inputValue: "Y"
				}/*,{
		    		xtype: 'combobox',
    ...
    buttons: [{
		text: '保存',
		iconCls:"save",
		handler: 'onSecretaryAccSave'
	}, {
		text: '确定',
		iconCls:"ensure",
		handler: 'onSecretaryAccEnsure'
	}, {
		text: '关闭',
		iconCls:"close",
		handler: 'onWinClose'
