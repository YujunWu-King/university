Ext.define('KitchenSink.view.template.sitetemplate.menu.menuManges.siteMenuTypeInfoPanel', {
    extend: 'Ext.panel.Panel',
    xtype: 'siteMenuTypeInfoPanel', 
	controller: 'siteTypeInfo',
	requires: [
	    'Ext.data.*',
        'Ext.grid.*',
        'Ext.util.*',
		...
		'KitchenSink.view.template.sitetemplate.menu.menuManges.siteStateStroe',
		'KitchenSink.view.template.sitetemplate.menu.menuManges.menuTypeController',
		'KitchenSink.view.template.sitetemplate.menu.menuManges.menuIconStore'
	],
    title: '菜单类型设置', 
