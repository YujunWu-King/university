Ext.define('KitchenSink.view.clueManagement.clueManagement.export.exportExcelController', {
    ...
    downloadFile: function(grid, rowIndex){
        ...
        if(procInsId != ""){
            var tzParams = '{"ComID":"TZ_XSXS_DRDC_COM","PageID":"TZ_XSXS_DRDC_STD","OperateType":"DOWNLOAD","comParams":{"procInsId":"'+ procInsId +'"}}';
            //保存数据
    ...
    exportGridSave: function(btn){
        ...
        var comParams ="";
        if(removeJson != ""){
            comParams = '"delete":[{"data":[' + removeJson + "]}]";
        }

        //提交参数
        var tzParams = '{"ComID":"TZ_XSXS_DRDC_COM","PageID":"TZ_XSXS_DRDC_STD","OperateType":"U","comParams":{'+comParams+'}}';
        //保存数据
