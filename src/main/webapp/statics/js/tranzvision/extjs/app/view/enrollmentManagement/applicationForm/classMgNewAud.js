Ext.define('KitchenSink.view.enrollmentManagement.applicationForm.classMgNewAud', {
    ...
    requires: [
			...
			//   'KitchenSink.view.audienceManagement.myEnrollmentClueController',
               'KitchenSink.view.enrollmentManagement.applicationForm.classMgAudStore'
           ],
    xtype: 'newAudWindow', 
    title: '听众信息', 
	...
	initComponent: function () {
		var store = new KitchenSink.view.enrollmentManagement.applicationForm.classMgAudStore();
