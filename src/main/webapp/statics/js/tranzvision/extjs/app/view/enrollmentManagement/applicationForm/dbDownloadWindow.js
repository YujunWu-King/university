Ext.define('KitchenSink.view.enrollmentManagement.applicationForm.dbDownloadWindow', {
                ...
                items: [
                    {
                        ...
                        items: [
                            ...
                            {
                                title: Ext.tzGetResourse("TZ_BMGL_BMBSH_COM.TZ_BMGL_STU_STD.packageResult","材料打包结果"),
                                xtype: 'grid',
                                autoHeight: true,
                                frame:false,
                                minHeight:200,
