Ext.define('KitchenSink.view.security.user.userAccountEmNb', {
	...
	requires: [
		...
		'KitchenSink.view.security.user.userEmNbController',
		'KitchenSink.view.security.user.userModel',
        'KitchenSink.view.security.user.userEmNbStore'
    ],
    xtype: 'userEmNbMg',
    ...
    initComponent: function () {
	    //用户账号信息
	    var store = new KitchenSink.view.security.user.userEmNbStore();
