Ext.define('KitchenSink.view.security.user.userAccountNb', {
	...
	requires: [
		...
		'KitchenSink.view.security.user.userNbController',
		'KitchenSink.view.security.user.userModel',
        'KitchenSink.view.security.user.userNbStore'
    ],
    xtype: 'userNbMg',
	controller: 'userNbMg',
    columnLines: true,
    ...
    initComponent: function () {
	    //用户账号信息
	    var store = new KitchenSink.view.security.user.userNbStore();
        ...
        Ext.apply(this, {
            ...
            columns: [{ 
                ...
                //text: '用户名称',
				text:Ext.tzGetResourse("TZ_AQ_NB_YHZHGL_COM.TZ_NB_YHZHGL_STD.usName","用户名称"),
                sortable: true,
                dataIndex: 'usName',
                minWidth: 100,
                flex: 1
                ...
                //text: '手机号码',
				text:Ext.tzGetResourse("TZ_AQ_NB_YHZHGL_COM.TZ_NB_YHZHGL_STD.mobile","手机号码"),
                sortable: true,
                dataIndex: 'mobile',
                width: 120
            },{
                //text: '电子邮箱',
				text:Ext.tzGetResourse("TZ_AQ_NB_YHZHGL_COM.TZ_NB_YHZHGL_STD.email","电子邮箱"),
                sortable: true,
                dataIndex: 'email',
                minWidth: 150,
				flex: 1
            	...
            	disabled: true,
                //text: '锁定',
							text:Ext.tzGetResourse("TZ_AQ_NB_YHZHGL_COM.TZ_NB_YHZHGL_STD.acctLock","锁定"),
                sortable: true,
                dataIndex: 'acctLock',
                width: 60
            }*/
            ...
            /*,{
            	...
            	disabled: false,
                //text: '手机绑定标志',
				text:Ext.tzGetResourse("TZ_AQ_NB_YHZHGL_COM.TZ_NB_YHZHGL_STD.mBindFlag","手机绑定标志"),
                sortable: true,
                dataIndex: 'mBindFlag',
                listeners: {
            	...
            	xtype: 'checkcolumn',
                //text: '邮箱绑定标志',
				text:Ext.tzGetResourse("TZ_AQ_NB_YHZHGL_COM.TZ_NB_YHZHGL_STD.eBindFlag","邮箱绑定标志"),
                sortable: true,
                dataIndex: 'eBindFlag',
                listeners: {
                	"beforecheckchange": function(){
            ...
            ,{
                //text: '账号类型',
				text:Ext.tzGetResourse("TZ_AQ_NB_YHZHGL_COM.TZ_NB_YHZHGL_STD.rylx","账号类型"),
                sortable: true,
                dataIndex: 'rylx',
                minWidth: 110,
                flex: 1
            ...
            ,{
                //text: '激活状态',
				text:Ext.tzGetResourse("TZ_AQ_NB_YHZHGL_COM.TZ_NB_YHZHGL_STD.jhState","激活状态"),
                sortable: true,
                dataIndex: 'jhState',
                width: 85
            },{
                //text: '激活方式',
				text:Ext.tzGetResourse("TZ_AQ_NB_YHZHGL_COM.TZ_NB_YHZHGL_STD.jhMethod","激活方式"),
                sortable: true,
                dataIndex: 'jhMethod',
                minWidth: 100,
                flex: 1
