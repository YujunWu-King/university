Ext.define('KitchenSink.view.security.user.userAccountNb', {
	...
	header:false,
	frame: true,
    dockedItems:[{xtype:"toolbar",dock:"bottom",ui:"footer",items:['->',{minWidth:80,text:"保存",iconCls:"save",handler:'saveUserInfos'}]},{
		xtype:"toolbar",
		items:[
    ...
    initComponent: function () {  
    	console.log("2");
	    //用户账号信息
	    var store = new KitchenSink.view.security.user.userStore("NB");
        Ext.apply(this, {
			store: store,
            columns: [{ 
                //text: '机构',
