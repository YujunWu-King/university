Ext.define('KitchenSink.view.siteManage.siteManage.menu.menuManges.menuController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.menuTypeInfo1', 
	requires: [
       'KitchenSink.view.siteManage.siteManage.menu.menuManges.siteMenuTypeInfoPanel'
    ],
    saveMenuInfos: function(btn){
		...
		//提交参数
		var tzParams = '{"ComID":"TZ_GD_ZDGL_COM","PageID":"TZ_ZD_CDLXGL_STD","OperateType":"U","comParams":{'+comParams+'}}';
        //保存数据
    ...
    addType: function() {
    	//是否有访问权限
		var pageResSet = TranzvisionMeikecityAdvanced.Boot.comRegResourseSet["TZ_GD_ZDGL_COM"]["TZ_ZD_CDLXSZ_STD"];
