Ext.define('KitchenSink.view.enrollProject.userApply.exportExcel.exportExcelStore', {
    extend: 'Ext.data.Store',
    alias: 'store.userApplyExportExcelStore',
    model: 'KitchenSink.view.enrollProject.userApply.exportExcel.exportExcelModel',
    autoLoad: true,
    pageSize: 5,
