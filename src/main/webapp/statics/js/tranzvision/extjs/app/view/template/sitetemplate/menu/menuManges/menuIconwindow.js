Ext.define('KitchenSink.view.template.sitetemplate.menu.menuManges.menuIconwindow', {
    extend: 'Ext.window.Window',
    xtype: 'menuIconwindow', 
	controller: 'menuIconController',
	requires: [
       'KitchenSink.view.template.sitetemplate.menu.menuManges.menuIconController'
    ],
    title: '菜单类型图标设置', 
								...
								if(fix.toLowerCase() == "jpg" || fix.toLowerCase() == "jpeg" || fix.toLowerCase() == "png" || fix.toLowerCase() == "gif" || fix.toLowerCase() == "bmp" || fix.toLowerCase() == "ico"){
									form.submit({
										...
										success: function (form, action) {
											...
											var tzParams = '{"ComID":"TZ_GD_ZDMB_COM","PageID":"TZ_GD_MENUICON_STD","OperateType":"EJSON","comParams":'+comParams+'}';
											Ext.Ajax.request({
