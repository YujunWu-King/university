Ext.define('KitchenSink.view.automaticScreen.autoScreen.autoScreenController', {
	extend: 'Ext.app.ViewController',
	alias: 'controller.autoScreenControllerBase',
	...
	searchAutoScreenStu: function(btn){
		...
		Ext.tzShowCFGSearch({
			cfgSrhId: 'TZ_AUTO_BASE_COM.TZ_AUTO_SCREEN_BS.TZ_CS_STU_BS_V',
			condition:
			{
				"TZ_CLASS_ID": classId,
				"TZ_BATCH_ID": batchId
			...
			callback: function(seachCfg){
				...
				var tzParams = '{"ComID":"TZ_AUTO_BASE_COM","PageID":"TZ_AUTO_SCREEN_BS","OperateType":"getSearchSql","comParams":'+seachCfg+'}';
	...
	editStuScreenDetails: function(grid,rowIndex,colIndex){
		...
		//是否有访问权限
		var pageResSet = TranzvisionMeikecityAdvanced.Boot.comRegResourseSet["TZ_AUTO_BASE_COM"]["TZ_ZDCS_INFO_BS"];
