Ext.define('KitchenSink.view.tzLianxi.ZXE.ZXDCKJSZ.dckjInfoPanel', {
    ...
    requires: [
        ...
        'KitchenSink.view.tzLianxi.ZXE.ZXDCKJSZ.dcauditKjYtStore',
        'KitchenSink.view.tzLianxi.ZXE.ZXDCKJSZ.dcauditKjJygzStore',
        'KitchenSink.view.tzLianxi.ZXE.ZXDCKJSZ.dckjController',
        'KitchenSink.view.tzLianxi.ZXE.ZXDCKJSZ.dckjJygzWindow'
    ],
    actType: 'add',//默认新增,
