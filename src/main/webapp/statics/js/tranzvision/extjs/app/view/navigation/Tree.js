Ext.define('KitchenSink.view.navigation.Tree', {
    ...
    title: TranzvisionMeikecityAdvanced.Boot.languagePackage['tz-frmwrk-lang-00001'],
    rootVisible: false,
    lines: false,
    useArrows: true,
    hideHeaders: true,
    ...
    split: true,
    stateful: true,
    stateId: 'tranzvision-framework-mainnav.west',
    collapsible: true,
    ...
    tools: [{
        type: 'up',
        tooltip: TranzvisionMeikecityAdvanced.Boot.languagePackage['tz-frmwrk-lang-00006'],
        listeners: {
            ...
            dockedItems : [
                {
                    xtype: 'textfield',
                    dock: 'top',
                    emptyText: TranzvisionMeikecityAdvanced.Boot.languagePackage['tz-frmwrk-lang-00002'],
