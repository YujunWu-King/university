Ext.define('KitchenSink.view.security.user.userEmNbController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.userEmNbMg',
    createUserAccClass: function(){
        //是否有访问权限
        var pageResSet = TranzvisionMeikecityAdvanced.Boot.comRegResourseSet["TZ_EM_NB_YHZHGL_COM"]["TZ_EMNB_YHZHXX_STD"];
        ...
        if(className == "" || className == undefined){
            Ext.MessageBox.alert('提示', '未找到该功能页面对应的JS类，页面ID为：TZ_EMNB_YHZHXX_STD，请检查配置。');
            return;
        }
    ...
    addUserAccount: function() {
        ...
        cmp.on('afterrender',function(){
           ...
           // var tzStoreParams = '{"usAccNum":"","orgId":"'+Ext.tzOrgID+'"}';
            ...
            //参数
            var tzParams = '{"ComID":"TZ_EM_NB_YHZHGL_COM","PageID":"TZ_EMNB_YHZHXX_STD","OperateType":"QF","comParams":{"usAccNum":"","orgId":"'+Ext.tzOrgID+'"}}';
            //加载数据
    ...
    editUserAccount: function() {
        ...
        cmp.on('afterrender',function(){
            ...
            //参数
            var tzParams = '{"ComID":"TZ_EM_NB_YHZHGL_COM","PageID":"TZ_EMNB_YHZHXX_STD","OperateType":"QF","comParams":{"usAccNum":"'+usAccNum+'","orgId":"'+orgID+'"}}';
            //加载数据
            Ext.tzLoad(tzParams,function(responseData){
                //用户账号信息数据
                /*
    ...
    saveUserInfos: function(btn){
        ...
        if(removeJson != ""){
            ...
            //提交参数
            var tzParams = '{"ComID":"TZ_EM_NB_YHZHGL_COM","PageID":"TZ_EMNB_YHZHGL_STD","OperateType":"U","comParams":{'+comParams+'}}';
            //保存数据
    ...
    resetPassword: function(){
        ...
        if (!win) {
            className = 'KitchenSink.view.security.user.setEmNbPassword';
            Ext.syncRequire(className);
            ViewClass = Ext.ClassManager.get(className);
            //新建类
            win = new ViewClass();
    ...
    lockUserAccount: function(){
        ...
        Ext.MessageBox.confirm('确认', '您确定要锁定所选记录吗?', function(btnId){
            if(btnId == 'yes'){
                ...
                //提交参数
                var tzParams = '{"ComID":"TZ_EM_NB_YHZHGL_COM","PageID":"TZ_EMNB_YHZHGL_STD","OperateType":"LOCK","comParams":{'+comParams+'}}';
                Ext.tzSubmit(tzParams,function(){
                },"锁定账号成功",true,this);
            }
        },this);
    ...
    getUserAccInfoParams:function(){
        ...
        //提交参数
        var tzParams = '{"ComID":"TZ_EM_NB_YHZHGL_COM","PageID":"TZ_EMNB_YHZHXX_STD","OperateType":"U","comParams":{'+comParams+'}}';
    ...
    onSetPwdEnsure: function(btn){
        ...
        comParams = '"data":[' + editJson + "]";
        //提交参数
        var tzParams = '{"ComID":"TZ_EM_NB_YHZHGL_COM","PageID":"TZ_EMNB_YHZHGL_STD","OperateType":"PWD","comParams":{'+pwdParams+","+comParams+'}}';
        Ext.tzSubmit(tzParams,function(){
            //重置表单
            form.reset();
            //关闭窗口
    ...
    searchUserList: function(btn){
    	Ext.tzShowCFGSearch({
            ...
            cfgSrhId: 'TZ_EM_NB_YHZHGL_COM.TZ_EMNB_YHZHGL_STD.TZ_YHZH_EMNB_VW',
            condition:
            {
