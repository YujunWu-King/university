Ext.define('KitchenSink.view.enrollmentManagement.applicationForm.SiampleAuditApplicationFormController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.SiampleAuditApplicationForm',
        ...
        if(filename != ""){
            ...
            form.submit({
                ...
                success: function (form, action) {
                    ...
                    var resRefLetterGrid = btn.findParentByType("SiampleAuditAppFormPanel").down('grid[name=refLetterGrid]');
                ...
                success: function (form, action) {
                    ...
                    if (strAppId!=""){
                        ...
                        Ext.tzSubmit(tzParams,function(responseData){
                            ...
                            var fileGrid = btn.findParentByType("SiampleAuditAppFormPanel").down('grid[name=fileGrid]');
                            var fileStore = fileGrid.getStore();
                            fileStore.reload();
                            win.close();
                        },"",true,this);
