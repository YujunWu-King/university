function checkExplorer(language){
	...
	borwer_tip = borwer_tip + '      <span style="color:#f98a43;font-size:14px;">系统检测到您所使用的浏览器版本过低，为保证您正常登录此网站，推荐使用如下浏览器：</span>';
	...
	borwer_tip = borwer_tip + '      <div style="font-size:12px;">新版内网试运行期间技术支持电话：010-58448503（9:00~18:00）；邮箱：service@tranzvision.com.cn</div>';
	borwer_tip = borwer_tip + '      <span style="color:#f98a43;font-size:14px;">The system detects that the browser version you are using is too old .<br/> To ensure you log on to this system,it is recommended to use the browsers as follows:</span>';
	...
	borwer_tip = borwer_tip + '      <div style="font-size:12px;">IT Support for the new MBA student intranet: service@tranzvision.com.cn</div>';
	borwer_tip = borwer_tip + '    </div>';
	borwer_tip = borwer_tip + '    <div id="browser_tip_popup_button" style="width: 130px;height: 34px;font-size: 14px;color: #fff;background-color: #f98a43;border-radius: 6px;-webkit-border-radius: 6px;text-align: center;line-height: 34px;margin: 0 auto;cursor: pointer;margin-bottom:10px;">' + buttonLabel + '</div>';
	borwer_tip = borwer_tip + '  </div>';
