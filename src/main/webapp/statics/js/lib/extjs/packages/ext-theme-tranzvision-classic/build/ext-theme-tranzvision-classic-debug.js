Ext.define('ExtThemeTranzvisionClassic.Component', {
...
Ext.define('ExtThemeTranzvisionClassic.resizer.Splitter', {
    override: 'Ext.resizer.Splitter',
    size: 8
});

Ext.define('ExtThemeTranzvisionClassic.toolbar.Toolbar', {
    override: 'Ext.toolbar.Toolbar',
    usePlainButtons: false,
    border: false
});

Ext.define('ExtThemeTranzvisionClassic.layout.component.Dock', {
...
Ext.define('ExtThemeTranzvisionClassic.panel.Panel', {
...
Ext.define('ExtThemeTranzvisionClassic.panel.Table', {
...
Ext.define('ExtThemeTranzvisionClassic.container.ButtonGroup', {
    override: 'Ext.container.ButtonGroup',
    usePlainButtons: false
});

Ext.define('ExtThemeTranzvisionClassic.toolbar.Paging', {
    override: 'Ext.toolbar.Paging',
    defaultButtonUI: 'plain-toolbar',
    inputItemWidth: 40
});

Ext.define('ExtThemeTranzvisionClassic.picker.Month', {
...
Ext.define('ExtThemeTranzvisionClassic.form.field.HtmlEditor', {
    override: 'Ext.form.field.HtmlEditor',
    defaultButtonUI: 'plain-toolbar'
});

Ext.define('ExtThemeTranzvisionClassic.grid.RowEditor', {
    override: 'Ext.grid.RowEditor',
    buttonUI: 'default-toolbar'
});

Ext.define('ExtThemeTranzvisionClassic.grid.column.RowNumberer', {
    override: 'Ext.grid.column.RowNumberer',
    width: 25
});

Ext.define('ExtThemeTranzvisionClassic.menu.Separator', {
    override: 'Ext.menu.Separator',
    border: true
});

Ext.define('ExtThemeTranzvisionClassic.menu.Menu', {
