Ext.define('ExtThemeYenchingClassic.Component', {
...
Ext.define('ExtThemeYenchingClassic.resizer.Splitter', {
    override: 'Ext.resizer.Splitter',
    size: 8
});

Ext.define('ExtThemeYenchingClassic.toolbar.Toolbar', {
    override: 'Ext.toolbar.Toolbar',
    usePlainButtons: false,
    border: false
});

Ext.define('ExtThemeYenchingClassic.layout.component.Dock', {
...
Ext.define('ExtThemeYenchingClassic.panel.Panel', {
...
Ext.define('ExtThemeYenchingClassic.panel.Table', {
...
Ext.define('ExtThemeYenchingClassic.container.ButtonGroup', {
    override: 'Ext.container.ButtonGroup',
    usePlainButtons: false
});

Ext.define('ExtThemeYenchingClassic.toolbar.Paging', {
    override: 'Ext.toolbar.Paging',
    defaultButtonUI: 'plain-toolbar',
    inputItemWidth: 40
});

Ext.define('ExtThemeYenchingClassic.picker.Month', {
...
Ext.define('ExtThemeYenchingClassic.form.field.HtmlEditor', {
    override: 'Ext.form.field.HtmlEditor',
    defaultButtonUI: 'plain-toolbar'
});

Ext.define('ExtThemeYenchingClassic.grid.RowEditor', {
    override: 'Ext.grid.RowEditor',
    buttonUI: 'default-toolbar'
});

Ext.define('ExtThemeYenchingClassic.grid.column.RowNumberer', {
    override: 'Ext.grid.column.RowNumberer',
    width: 25
});

Ext.define('ExtThemeYenchingClassic.menu.Separator', {
    override: 'Ext.menu.Separator',
    border: true
});

Ext.define('ExtThemeYenchingClassic.menu.Menu', {
