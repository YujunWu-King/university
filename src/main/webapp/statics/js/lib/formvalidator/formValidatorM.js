...
$.formValidator = 
{
	...
	initConfig : function(controlOptions)
	{
		...
		/*张彬彬注释,由于IE8浏览器不支持,formValidator的Style样式不采用异步加载的方式,在需要的加载的地方，同步引用对应的css样式即可*/
		/*读取主题对应的样式
...
//			console.log(elem.settings[0].tipID);
			...
			var html = showclass == "onShow" ? onShowHtml : (showclass == "onCorrect" ? onCorrectHtml : onErrorHtml);
			//console.log(html);
			if(html.length = 0)
			{
				tip.hide()
	...
	//		});
		...
		else if (srcTag == "select")
		{
			jqobj.bind({
				...
				focus: function(){	
					if (initConfig.mode != "AlertTip") {
						//刘哲注释$.formValidator.setTipState(this, "onFocus", setting.onFocus)
					};
				},
				//失去焦点
				blur: function(){
...
var initConfig_setting = 
{
	...
	mode : "FixTip",			//显示模式
	errorFocus:false,			//第一个错误的控件获得焦点,ture获取焦点/false不获取焦点
...
var formValidator_setting = 
{
	validatorGroup : "1",
	onShowText : "",
	onShowTextColor:{mouseOnColor:"#000000",mouseOutColor:"#666666"},
	onShowFixText:"",
	onShow :"请输入内容",
	onFocus: "请输入内容",
	onCorrect: "输入正确",
