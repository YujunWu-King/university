...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars:[
                    ['source','bold', 'italic', 'underline','indent', '|','justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|','strikethrough', 'superscript', 'subscript', 'removeformat',
        			'formatmatch',  'pasteplain', '|', 'forecolor', 'backcolor', 'fontsize','|', 
                    'link', 'unlink'
                    ]
                ]
...
//        }
        ...
        ,iframeCssUrl: '/ueditor/themes/iframe.css' //给编辑器内部引入一个css文件
