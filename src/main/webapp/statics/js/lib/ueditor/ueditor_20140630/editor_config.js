...
window.UEDITOR_HOME_URL = "/ueditor/"
    ...
    var tmp = window.location.pathname;
        ...
        //URL = "http://202.120.24.168:8000/ueditor/";
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        //word转存配置区
        ,wordImageUrl:"/ueditor/jsp/imageUp.jsp"             //word转存提交地址
       ...
       // ,customDomain:true
        ...
        ,toolbars:[
                    [ 'Source', '|', 'Undo', 'Redo', '|',
                      ...
                      'RowSpacingTop', 'RowSpacingBottom','LineHeight','|', 'Link', 'Unlink', '|','FontFamily', 'FontSize', '|',
                      '', 'Indent', '|',
                      'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyJustify', '|',
                      'Anchor', '|','Emotion', 'InsertVideo', 'Map',   '|', 'ImageNone', 'ImageLeft', 'ImageRight', 'ImageCenter', '|',  
                      'Horizontal','|', 'Date', 'Time', '|','Spechars','|', 'SearchReplace','|',
                      'InsertImage','|','InsertTable','|', 'DeleteTable', 'InsertParagraphBeforeTable', 'InsertRow', 'DeleteRow', 'InsertCol', 'DeleteCol', 'MergeCells', 'MergeRight', 'MergeDown', 'SplittoCells', 'SplittoRows', 'SplittoCols', '|','Preview', '|'
                       ]
              ]
