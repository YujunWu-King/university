...
(function ($) {
	...
	*/
	var Timepicker = function () {
		...
		this.regional['ZHS'] = { // Default regional settings
			currentText: '现在时间',
			closeText: '完成',
			amNames: ['AM', 'A'],
			pmNames: ['PM', 'P'],
		...
		this.regional['ENG'] = { // ENG regional settings
		...
		try { 
			if(SurveyBuild  && SurveyBuild.BMB_LANG === 'ENG'){
				$.extend(this._defaults, this.regional['ENG']);
			}else{
				$.extend(this._defaults, this.regional['ZHS']);
			}
		} catch (e){ 
			$.extend(this._defaults, this.regional['ZHS']);
		}
