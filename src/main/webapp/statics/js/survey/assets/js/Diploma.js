/*====================================================================
+ 功能描述：学历控件，可以供选择预置的学历							++
+ 开发人：叶少威													++
+ 开发日期：2015-05-15												++
=====================================================================*/
SurveyBuild.extend("Diploma", "baseComponent", {
    itemName: "学历",
    title:"学历",
    "StorageType":"S",
    option: {},
    _init: function(d, previewmode) {
		...
		var diploma = ["博士研究生","硕士研究生","本科",'专科','中专/高中','初中'];
        for (var i = 1; i <= 6; ++i) {
            this.option[d + i] = {
                code: i,
                txt: diploma[i-1],
    ...
    _getHtml: function(data, previewmode) {
        ...
        if (previewmode) {
            if(SurveyBuild._readonly){
                ...
                c += '          <select name="' + data.itemId + '" class="chosen-select" style="width:251px;" id="' + data.itemId + '" title="' + data.itemName + '">';
                c +=                e;
                c += '          </select>';
                c += '      </div>' + data.suffix;
