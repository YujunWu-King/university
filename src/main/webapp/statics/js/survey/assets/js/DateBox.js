    ...
    _getHtml: function(data, previewmode) {
        ...
        if (previewmode) {
            ...
            if(SurveyBuild.accessType == "P"){
                ...
                c += '      <img id="' + data.itemId + '_Btn" src="/tranzvision/images/calendar.png" style="position:relative;top:5px;left:-35px;cursor:pointer;">';
                ...
                c += '      <img id="' + data.itemId + '_Btn" src="/tranzvision/images/calendar.png" style="cursor: pointer; position: absolute; right: 10px; top: 8px;">';
                c += '  </div>';
                c += '</div>';
            }
        } else {
