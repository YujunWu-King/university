...
//													c = '<li><a onclick=SurveyBuild.viewImageSet(this,\"'+instanceId+'\") file-index="'+rstObj.index+'"><p>'+rstObj.viewFileName+'</p></a><div class="img_del" onclick=SurveyBuild.deleteFile(this,\"'+instanceId+'\")><img width="15" height="15" src="'+TzUniversityContextPath+'/statics/js/onlineSurvey/images/del.png" title="'+MsgSet["DEL"]+'">&nbsp;'+MsgSet["DEL"]+'</div></li>';
//												} else  if(SurveyBuild.accessType == "M" && className == "ImgUpload"){
//													c = '<li><a onclick=SurveyBuild.viewImageSet(this,\"'+instanceId+'\") file-index="'+rstObj.index+'"><p>'+rstObj.viewFileName+'</p></a><img src="'+TzUniversityContextPath+'/statics/js/onlineSurvey/images/del.png" onclick=SurveyBuild.deleteFile(this,\"'+instanceId+'\") title="'+MsgSet["DEL"]+'"></li>';
//												}else if(SurveyBuild.accessType == "P" && className == "AttachUpload"){
//                                                   c = '<li><a onclick=SurveyBuild.downLoadFile(this,\"'+instanceId+'\") file-index="'+rstObj.index+'"><p>'+rstObj.viewFileName+'</p></a><div class="img_del" onclick=SurveyBuild.deleteFile(this,\"'+instanceId+'\")><img width="15" height="15" src="'+TzUniversityContextPath+'/statics/js/onlineSurvey/images/del.png" title="'+MsgSet["DEL"]+'">&nbsp;'+MsgSet["DEL"]+'</div></li>';
//                                                }else{
//                                                    c = '<li><a onclick=SurveyBuild.downLoadFile(this,\"'+instanceId+'\") file-index="'+rstObj.index+'"><p>'+rstObj.viewFileName+'</p></a><img  src="'+TzUniversityContextPath+'/statics/js/onlineSurvey/images/del.png" onclick=SurveyBuild.deleteFile(this,\"'+instanceId+'\") title="'+MsgSet["DEL"]+'"></li>';
//                                                }
												if(SurveyBuild.accessType == "P" && className == "ImgUpload"){
